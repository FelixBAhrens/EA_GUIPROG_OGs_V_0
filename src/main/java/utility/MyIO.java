...
public class   MyIO
{
    ...
    /**
     * Ueberladene print-Methode, die neben dem Text auch die Schriftfarbe uebergeben bekommt. Ein Text wird ausgegeben.
     * @param text Der Text der ausgegeben werden soll.
     ...
     * @precondition Der eingegebene Text muss ein String sein, die Farben muessen Parameter der Klasse ConsoleColor sein.
