...
public class ArtefaktController
{
     ...
     * Dieser muss die uebergebenen Werte akzeptieren und jeweils eine neue Instanz vom
     * Artefakt erstellen. Die Konstanten erreichbar sein.
     *
     * @post Es wurden die drei Artefakte {Statue, Schwert, Ring}
     * erstellt und als Artefakt -Array zurueckgegeben.
     *
     * @author Felix Ahrens.
     */
