...
import javafx.scene.control.Label; import javafx.scene.control.ProgressBar; import javafx.scene.input.MouseEvent; import javafx.scene.layout.HBox;
...
public class BasisCampController extends StadtController
{
    ...
    */
     ...
     *
     * @pre Die ProgressBars muessen als Parameter in der Klasse deklariert sein und ueber
     * die ID mit ihrem Aequivalent in der FXML-Datei verbunden sein.
     *
     ...
     *
     * @pre Die verwendeten GUI-Elemente muessen existieren und in der FXML-Datei mit
     * derselben "fx:id" aufgefuehrt sein. Die Konstanten, Methoden und Klassen muessen
     * erreichbar sein.
     *
     * @post Das "detailLabel" wurde auf den jeweils logisch zugehoerigen Wert der
     * Aufrufquelle gesetzt.
     *
     * @author Felix Ahrens.
     */
    @FXML
