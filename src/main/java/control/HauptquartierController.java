...
/**
 * Klasse HauptquartierController zum Steuern der Funktionalitaet des Hauptquartiers. Diese Klasse ist die
 * ControllerKlasse der "hauptquartier-view.fxml" und beinhaltet die Methoden zum Steuern und Setzen der Nutzereingaben
 * und Informationsausgaben.
 *
...
public class HauptquartierController extends StadtController
{
     ...
     * @pre Die verwendeten Methoden muessen existieren. Die Methode muss von einem der vier Buttons zum Waehlen der
     * Missionen aufgerufen werden.
     * @post Das Enum wurde gesetzt und die Wahl der Mission visuell und durch das Anzeigen von Informationen der
     * nutzenden Person bestaetigt.
     * @Author Felix Ahrens
     */
    @FXML
     ...
     * @post Die der nutzenden Person angezeigten Belohnungen wurden gemaess der in Konstanten gespeicherten
     * Belohnungswerte aktualisiert und in einem Text verpackt.
     * @Author Felix Ahrens
     */
     ...
     *
     * @param belohnungsArray Die der Methode uebergebenen Integer-Belohnungswerte: {Holz, Stein, Gold, Gesundheit,
     *                        Banonas}.
     * @return Als String einen Text mit huebsch verpackten Informationen zu den Belohnungen.
     * @pre Die verwendeten Konstanten muessen existieren. Das eindimensionale Integer-Array muss auf den ersten fuenf
     * Plaetzen die Belohnungen in folgender Reihenfolge enthalten {Holz, Stein, Gold, Gesundheit, Banonas}.
     * @post Es wurde ein String zurueckgegeben, der fuer die nutzende Person wichtige Informationen zu den der Methode
     * uebergebenen Belohnungen enthaelt.
     * @Author Felix Ahrens
     */
    ...
    /**
     * Methode, die eine Mission startet. Teilweise werden die Enums der Karte oder des Kampfes gesetzt, um den
     * Controllerklassen fuer Karte und Kampf die Information fuer den ausgewaehlten Kampf zu uebergeben. Fuer karte und
     * Kampf wird allerdings zuerst das Einheiten-Menue geladen.
     *
     * @pre Die Konstanten, das Enum, die Klassen und die Methoden muessen erreichbar sein und "design-by-contract"
     * erfuellen.
