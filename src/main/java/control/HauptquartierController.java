...
{
    @FXML
    public Label entschluesselnDetail;
    @FXML
    ...
    /**
     * Enum fuer die Mission, das die ausgewaehlte Mission speichert und ueberall
     * in der Klasse erreichbar ist.
     *
     * @author Felix Ahrens.
     */
    private enum Mission
    {
        ENTSCHLUESSELN(Strings.ENTSCHLUESSELN),
    ...
    @FXML
    public AnchorPane entschluesselnPane;
    @FXML
    ...
    public void setzeEnumNachID (String ID)
    {
        switch (ID)
        {
            case Strings.ID_BUTTON_ENTSCHLUESSELN -> missionsName = Mission.ENTSCHLUESSELN;
     ...
     *
     * @param event Das Ereignis, das durch eine Mausaktion ausgeloest wurde
     * und zum Methodenaufruf gefuehrt hat.
     *
     * @pre Die verwendeten Methoden muessen existieren. Die Methode muss von einem
     * der vier Buttons zum Waehlen der Missionen aufgerufen werden.
     *
     * @post Das Enum wurde gesetzt und die Wahl der Mission visuell und durch das
     * Anzeigen von Informationen der nutzenden Person bestaetigt.
     *
     * @author Felix Ahrens.
     */
    @FXML
     ...
     *
     * @post Das "detailLabel" zeigt der nutzenden Person einen kontextuellen
     * Text zur gewaehlten Mission an.
     *
     * @autor Felix Ahrens.
     */
    public void aktualisiereMissionDetailLabel ()
    {
        ...
        {
            case ENTSCHLUESSELN -> Strings.TEXT_ENTSCHLUESSELN;
     ...
     *
     * @pre Die Konstanten, GUI-Elemente und Methoden muessen existieren
     * und erreichbar sein.
     *
     * @post Die der nutzenden Person angezeigten Belohnungen wurden gemaess der
     * in Konstanten gespeicherten Belohnungswerte aktualisiert und in einem Text verpackt.
     *
     * @author Felix Ahrens.
     */
    public void aktualisiereangezeigteBelohnungen ()
    {
        entschluesselnDetail.setText(erstelleBelohnungsText(Konstanten.BELOHNUNGEN_ENTSCHLUESSELN));
     ...
     *
     * @return Als String einen Text mit huebsch verpackten Informationen zu den
     * Belohnungen.
     *
     * @pre Die verwendeten Konstanten muessen existieren. Das eindimensionale
     * Integer-Array muss auf den ersten fuenf Plaetzen die Belohnungen in folgender
     * Reihenfolge enthalten {Holz, Stein, Gold, Gesundheit, Banonas}.
     *
     * @post Es wurde ein String zurueckgegeben, der fuer die nutzende Person
     * wichtige Informationen zu den der Methode uebergebenen Belohnungen enthaelt.
     *
     * @author Felix Ahrens.
     */
    ...
    /**
     * Methode, die eine Mission startet. Teilweise werden die Enums der Karte oder
     * des Kampfes gesetzt, um den Controllerklassen fuer Karte und Kampf die Information
     * fuer den ausgewaehlten Kampf zu uebergeben. Fuer karte und Kampf wird
     * allerdings zuerst das Einheiten-Menue geladen.
     *
     * @pre Die Konstanten, das Enum, die Klassen und die Methoden muessen
     * erreichbar sein und "design-by-contract" erfuellen.
     *
    ...
    public void starteMission ()
    {
        if (missionsName != null)
        {
            ...
            {
                case ENTSCHLUESSELN -> Strings.FXML_MISSION_FLAPPYBIRD;
                case ENDGEGNER ->
                {
